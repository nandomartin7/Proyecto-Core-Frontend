...
export default {
  ...
  methods: {
    ...
    fetchAutomoviles(){
      axios.get('https://artistic-smile-production.up.railway.app/automovil')
        .then(response => {
    ...
    fetchClientes(){
      axios.get('https://artistic-smile-production.up.railway.app/cliente')
        .then(response => {
    ...
    fetchContratos(){
      axios.get('https://artistic-smile-production.up.railway.app/contrato')
        .then(response => {
    ...
    fetchEmpleados(){
      axios.get('https://artistic-smile-production.up.railway.app/empleado')
        .then(response => {
    ...
    fetchPlanes(){
      axios.get('https://artistic-smile-production.up.railway.app/plan')
        .then(response => {
    ...
    fetchUsos(){
      axios.get('https://artistic-smile-production.up.railway.app/uso')
        .then(response => {
    ...
    submitAutomovil(){
      axios.post('https://artistic-smile-production.up.railway.app/automovil', this.nuevoAutomovil)
        .then(() => {
    ...
    submitCliente(){
      axios.post('https://artistic-smile-production.up.railway.app/cliente', this.nuevoCliente)
        .then(() => {
          this.fetchClientes();
          this.resetCliente();
          this.$router.push('/inicio-admin');
    ...
    submitContrato(){
      ...
      axios.post('https://artistic-smile-production.up.railway.app/contrato', this.nuevoContrato)
        .then(() => {
            this.fetchContratos();
            this.resetContrato();
            this.$router.push('/inicio-admin');
    ...
    submitEmpleado(){
      axios.post('https://artistic-smile-production.up.railway.app/empleado', this.nuevoEmpleado)
        .then(() => {
          this.fetchEmpleados();
          this.resetEmpleado();
          this.$router.push('/inicio-admin');
    ...
    submitPlan(){
      axios.post('https://artistic-smile-production.up.railway.app/plan', this.nuevoPlan)
        .then(() => {
          this.fetchPlanes();
          this.resetPlan();
          this.$router.push('/inicio-admin');
    ...
    submitUso(){
      axios.post('https://artistic-smile-production.up.railway.app/uso', this.nuevoUso)
        .then(() => {
            this.fetchUsos();
            this.resetUso();
            this.$router.push('/inicio-admin');
    ...
    guardarCambiosAutomovil(){  
      axios.put(`https://artistic-smile-production.up.railway.app/automovil/${this.automovilEditando.idAutomovil}`, this.automovilEditando)
        .then(response => {
          this.fetchAutomoviles();
    ...
    guardarCambiosCliente() {
      axios.put(`https://artistic-smile-production.up.railway.app/cliente/${this.clienteEditando.idCliente}`, this.clienteEditando)
        .then(response => {
          this.fetchClientes();
          this.cancelarEdicion();
    ...
    guardarCambiosContrato(){
      axios.put(`https://artistic-smile-production.up.railway.app/contrato/${this.contratoEditando.idContrato}`, this.contratoEditando)
        .then(response => {
          this.fetchContratos();
          this.cancelarEdicion();
    ...
    guardarCambiosEmpleado(){
      axios.put(`https://artistic-smile-production.up.railway.app/empleado/${this.empleadoEditando.idEmpleado}`, this.empleadoEditando)
        .then(response => {
          this.fetchEmpleados();
          this.cancelarEdicion();
    ...
    guardarCambiosPlan(){
      axios.put(`https://artistic-smile-production.up.railway.app/plan/${this.planEditando.idPlan}`, this.planEditando)
        .then(response => {
          this.fetchPlanes();
          this.cancelarEdicion();
    ...
    guardarCambiosUso(){
      axios.put(`https://artistic-smile-production.up.railway.app/uso/${this.usoEditando.idUso}`, this.usoEditando)
        .then(response => {
          this.fetchUsos();
          this.cancelarEdicion();
    ...
    eliminarAutomovil(idAutomovil){
      axios.delete(`https://artistic-smile-production.up.railway.app/automovil/${idAutomovil}`)
        .then(() => {
    ...
    eliminarCliente(idCliente) {
      axios.delete(`https://artistic-smile-production.up.railway.app/cliente/${idCliente}`)
        .then(() => {
    ...
    eliminarContrato(idContrato) {
      axios.delete(`https://artistic-smile-production.up.railway.app/contrato/${idContrato}`)
        .then(() => {
    ...
    eliminarEmpleado(idEmpleado) {
      axios.delete(`https://artistic-smile-production.up.railway.app/empleado/${idEmpleado}`)
        .then(() => {
    ...
    eliminarPlan(idPlan) {
      axios.delete(`https://artistic-smile-production.up.railway.app/plan/${idPlan}`)
        .then(() => {
    ...
    eliminarUso(idUso) {
      axios.delete(`https://artistic-smile-production.up.railway.app/uso/${idUso}`)
        .then(() => {
